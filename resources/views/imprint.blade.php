...
<div class="p-5">
  ...
  <p>
    Dobby ("us", "we", or "our") operates the https://dobby.mighty-code.com
    website (the "Service").
  </p>
  ...
  <p>
    ...
    have associated with that data. Our Privacy Policy for Dobby is created with
    the help of the
    <a
  ...
  <p>
    ...
    accessible from https://dobby.mighty-code.com
  </p>
  ...
  <p>Dobby uses the collected data for various purposes:</p>
  <ul>
  ...
  <p>
    If you are located outside Switzerland and choose to provide information to
    us, please note that we transfer the data, including Personal Data, to
    Switzerland and process it there.
  </p>
  <p>
  ...
  <p>
    Dobby will take all steps reasonably necessary to ensure that your data is
  ...
  <p>
    Dobby may disclose your Personal Data in the good faith belief that such
    action is necessary to:
  </p>
  <ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of Dobby</li>
    <li>
  ...
  <ul>
    <li>By email: dobby@mighty-code.com</li>
  </ul>
</div>
@stop
