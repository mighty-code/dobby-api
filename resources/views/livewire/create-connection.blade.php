    ...
    <form wire:submit.prevent="create" class="flex flex-col space-y-4">
        <div class="grid grid-cols-12">
            <div class="col-span-5">
                <livewire:search-station-input placeholder="From" name="station"/>
            </div>
...
<x-icons.arrow-right class="h-8 w-8 text-white" />
            ...
            <div class="col-span-5">
                <livewire:search-station-input placeholder="To" name="destination"/>
            </div>
        </div>

        @if($showVia)
            <livewire:search-station-input placeholder="via" name="via"/>
        @endif
